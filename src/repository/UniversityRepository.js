...
class UniversityRepository {
  ...
  search(options = {}) {
    ...
    if (options.country) {
      ...
      results = results.filter(u => {
        var _a;
        return ((_a = u.country) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === country;
      });
    }
    if (options.countryCode) {
      ...
      results = results.filter(u => {
        var _a;
        return ((_a = u.countryCode) === null || _a === void 0 ? void 0 : _a.toUpperCase()) === code;
      });
    }
    if (options.type) {
    ...
    if (options.hasProgram) {
      ...
      results = results.filter(u => {
        var _a;
        return (_a = u.programs) === null || _a === void 0
          ? void 0
          : _a.some(p => p.name.toLowerCase().includes(programTerm));
      });
    }
    if (options.degreeLevel) {
      ...
      results = results.filter(u => {
        var _a;
        return (_a = u.degrees) === null || _a === void 0 ? void 0 : _a.some(d => degrees.includes(d));
      });
    }
    if (options.languages) {
      results = results.filter(u => {
        var _a;
        return (_a = options.languages) === null || _a === void 0
          ? void 0
          : _a.every(l => {
              var _a;
              return (_a = u.languages) === null || _a === void 0 ? void 0 : _a.includes(l);
            });
      });
    }
  ...
  stats() {
    ...
    const countByType = Object.values(University_1.UniversityType).reduce(
      (acc, t) => Object.assign(Object.assign({}, acc), { [t]: 0 }),
      {}
    );
    const countBySize = Object.values(University_1.UniversitySize).reduce(
      (acc, s) => Object.assign(Object.assign({}, acc), { [s]: 0 }),
      {}
    );
